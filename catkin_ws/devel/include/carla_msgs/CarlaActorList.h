...
struct CarlaActorList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::carla_msgs::CarlaActorInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::carla_msgs::CarlaActorInfo_<ContainerAllocator> >> _actors_type;
  _actors_type actors;
