...
struct CarlaTrafficLightInfoList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::carla_msgs::CarlaTrafficLightInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::carla_msgs::CarlaTrafficLightInfo_<ContainerAllocator> >> _traffic_lights_type;
