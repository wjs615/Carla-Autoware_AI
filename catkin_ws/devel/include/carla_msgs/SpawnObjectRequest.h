...
struct SpawnObjectRequest_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::diagnostic_msgs::KeyValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::diagnostic_msgs::KeyValue_<ContainerAllocator> >> _attributes_type;
